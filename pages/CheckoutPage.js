...
class CheckoutPage{
    constructor() { 
        ...
        this.continueBtn = Selector('[class="button-1 new-address-next-step-button"]')
        this.nextDayOption = Selector("input[id='shippingoption_1']")
        this.nextShippingBtn = Selector('[class="button-1 shipping-method-next-step-button"]')
        this.nextPaymentBtn = Selector('[class="button-1 payment-method-next-step-button"]')
        this.nextConfirmBtn = Selector('[class="button-1 payment-info-next-step-button"]')
        this.confirmOrderBtn = Selector('[class="button-1 confirm-order-next-step-button"]')
